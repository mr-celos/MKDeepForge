...
public class MkDeepforgeMod implements ModInitializer {
	public static final Logger LOGGER = LogManager.getLogger(MkDeepforgeMod.class);
	public static final String MODID = "mk_deepforge";
